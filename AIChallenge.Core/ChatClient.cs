...
public class ChatClient
{
    ...
    /// </summary>
    public async Task<AIChallenge.Models.RawApiResponse> SendCompletionAsync(
        string model,
        List<AIChallenge.Models.ApiMessage> messages,
        int? maxTokens,
        double? temperature,
    ...
    )
    {
        ...
        return new AIChallenge.Models.RawApiResponse
        {
